...
import type { SqlTransactionInterface, SqlPoolInterface } from "./sql";
declare namespace app {
	...
	interface SqlTransaction extends SqlTransactionInterface {
	}
	interface SqlPool extends SqlPoolInterface {
	}
	interface Config {
		/**
